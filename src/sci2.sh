 ...
 *************************************************************************/
 ...
 // (define isExtra                   $0200) //NOTE: defined in system.sh as "anExtra"
 // (define noTurn                    $0800) //NOTE: defined in system.sh as "fixedLoop"
 // (define skipCheck                 $1000) //NOTE: defined in system.sh
 // (define ignoreHorizon             $2000) //NOTE: defined in system.sh as "ignrHrz"
// (define ignAct                     $4000)
